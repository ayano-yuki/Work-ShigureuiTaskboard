        ...
        <div>
            ...
            <div className="menu-bar">
                <div className="left-menu">
                    ...
                    >
                        <path
                            d="M44.0601 35.0083C44.0601 43.326 37.3169 50.0646 28.9991 50.0646C20.682 50.0646 13.9382 43.3266 13.9382 35.0083C13.9382 26.6911 28.9992 7.98944 28.9992 7.98944C28.9992 7.98944 44.0601 26.6911 44.0601 35.0083Z"
                            fill="#8A7F78"
                        />
                    </svg>
                    <div>File</div>
